        ...
        htmlPost+=      "                                    </div>\n" +
                ...
                for (CommentViewDTO postComment:post.getComments()) {
                    htmlPost += "<div class=\"explore_feed_comment_box\">"+
                            ...
                            "<div class=\"explore_feed_comment_infobox1\" text=\""+postComment.getName()+"\">" +
                            "</div>" +
                            "<div class=\"explore_feed_comment_infobox2\" text=\""+postComment.getContent()+"\">" +
                            "</div>" +
                ...
                htmlPost += "</div><div class=\"explore_feed_footer\">\n" +
                        ...
                        "                                                    <span class=\"feed_footer_likeNumText\">\n" +
                        "                                                       좋아요\n" +
                        "                                                       <span class=\"feed_footer_likeNum\" id=\"likeCount2_" +post.getId()+"\" text=\""+(post.getLikes() != null ? post.getLikes().size() : 0)+"\"></span>만개\n" +
                        "                                                    </span>\n" +
                        "                                                               </div>\n" +
                        "                                                            </div>\n" +
                        "                                                            <div class=\"feed_footer_ownerCommentBox\">\n" +
